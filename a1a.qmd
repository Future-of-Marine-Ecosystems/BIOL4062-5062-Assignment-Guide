...
If you don't have any zeroes, you don't have to bother with this at all.
...
We can use the eigenvalues to reproduce the rest of the `princomp()` output. The proportion of variance is the value of each eigenvalue divided by the sum of all the eigenvalues. The cumulative proportion is the cumulative sum of the proportions of variance. Since there are 5 components, the cumulative proportion of component 5 is 1 (i.e. all of the variance).
